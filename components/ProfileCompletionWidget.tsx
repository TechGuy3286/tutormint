...
export default function ProfileCompletionWidget({
  ...
  return (
    <section className="bg-white border border-gray-200 rounded-2xl p-4 sm:p-5 space-y-3">
      ...
      <Link
        href={href}
        className="gap-1.5 flex items-center justify-center min-h-[44px] w-full py-3 bg-tm-red hover:bg-tm-red-hover text-white font-bold text-xs rounded-xl transition-colors"
      >
