...
export default function HireButton({
  ...
  return (
    <button
      ...
      onClick={onClick}
      disabled={busy}
      className={`inline-flex min-h-[44px] items-center justify-center gap-1.5 rounded-xl bg-tm-navy px-4 text-xs font-bold text-white hover:bg-tm-navy-hover disabled:opacity-60 ${className}`}
    >
