...
export default function CompleteProfile() {
  ...
  const handleVideoUploadSubmit = async (e: React.FormEvent) => {
    e.preventDefault();
    if (!videoFile) {
      setErrorMsg("Please select your 60-second video introduction.");
      return;
    }
            ...
            <div className="bg-white rounded-2xl shadow-sm border border-gray-200 p-8 space-y-6">
              <div>
                ...
                <p className="text-xs text-gray-500 mt-1">
                  Record a 60-second video introducing yourself and <strong>clearly showing your degree/certificates</strong> on camera. Videos are uploaded directly to our platform and synced to the official TutorMint YouTube channel.
                </p>
              </div>
              
              {successMsg && <div className="p-4 bg-green-50 border border-green-200 text-green-800 text-xs font-bold rounded-xl">{successMsg}</div>}
