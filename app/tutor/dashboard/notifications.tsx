  ...
  return (
    <div className="bg-white p-6 rounded-2xl border border-gray-200 shadow-sm space-y-4 my-6">
      <div className="flex justify-between items-center">
        ...
        <span className="px-2 py-0.5 bg-tm-tint-green text-tm-green-deep text-[10px] font-bold rounded-full">Live Feed</span>
      </div>

      <div className="space-y-3">
        {notifications.map((note, idx) => (
          <div key={note.id || idx} className="p-4 bg-tm-tint-green/60 border border-tm-green-deep/30 rounded-xl flex items-start gap-3">
