...
const FALLBACK: Record<SignupStage, string> = {
  ...
  mobile_unverified:
    'Hi {name}, thanks for signing up to TutorMint. To finish, enter the verification code we sent to your mobile on WhatsApp. If you did not receive one, reply and our team will verify your number for you.',
  profile_unfinished:
