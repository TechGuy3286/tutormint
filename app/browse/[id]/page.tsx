  ...
  if (!tutor) {
    return (
      <div className="min-h-screen flex flex-col items-center justify-center space-y-3 bg-[#F8FAFC] text-center p-6">
        ...
        <Link href="/browse" className="px-6 py-3 bg-[#0F172A] text-white font-bold text-xs rounded-xl">
    ...
    <main className="min-h-screen bg-[#F8FAFC] py-10 px-4 sm:px-12 text-[#334155]">
      <div className="max-w-4xl mx-auto space-y-6">
        ...
        <div className="text-xs font-bold text-gray-400 flex items-center gap-2">
          ...
          <span>/</span>
          <Link href="/browse" className="hover:text-[#0F172A] transition-colors">Find Tutors</Link>
          <span>/</span>
